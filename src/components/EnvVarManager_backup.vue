        ...
        <div class="header-content">
          <div class="header-info">
            <div class="title-section">
              <h1 class="title">Windows 环境变量管理器</h1>
              <p class="subtitle">可视化管理系统和用户环境变量</p>
            </div>
            <!-- 管理员权限提示 -->
            <el-alert v-if="!isAdmin" title="当前未以管理员身份运行" type="warning" :closable="false" show-icon
              class="admin-warning">
              <template #default>
                <p>部分系统环境变量操作需要管理员权限</p>
                <el-button type="primary" size="small" @click="requestAdminPrivileges" class="admin-btn">
                  以管理员身份重启
                </el-button>
              </template>
            </el-alert>
          ...
          <div class="header-actions">
            <el-button @click="loadEnvVars" :loading="loading" size="large" class="refresh-btn">
              <el-icon>
                <Refresh />
              </el-icon>
              刷新
              ...
              <div class="collapse-header">
                <div class="header-info">
                  ...
                  <div class="header-text">
                    ...
                    <p class="section-desc">共 {{ systemVars.length }} 个变量 (需要管理员权限修改)</p>
                  </div>
                </div>
                <div class="header-actions">
              ...
              <div class="collapse-header">
                <div class="header-info">
                  ...
                  <div class="header-text">
                    ...
                    <p class="section-desc">共 {{ userVars.length }} 个变量 (当前用户)</p>
                  </div>
                </div>
                <div class="header-actions">
